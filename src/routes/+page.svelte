...
<div class="w-full h-screen flex flex-col justify-center items-center">
    ...
    <h1 class="text-4xl font-bold">Gopher Hours</h1>
    <br>
    <p class="text-lg">View all office hours for your courses. Find TAs, locations, and times.</p>
    Homepage under cosntruction!
    <br>
    <img src="/favicon.ico" alt="Gopher" class="w-1/3 mt-4">
      <br>
